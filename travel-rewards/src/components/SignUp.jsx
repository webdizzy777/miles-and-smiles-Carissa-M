...
function SignUp({ setIsLoggedIn, setFirstName, setUserId, firstName }) {
  ...
  async function registerUser() {
    try {
      ...
      setErrorMsg(
        "Network error. Please try again later. Message: " + error.message
      );
      setDisplayError(true);
    }
  }
  ...
  return (
    <main>
      <div className="customForm">
        <h2>
          <span className="blackOpaque"> Welcome! Create your account:</span>
        </h2>
        <form onSubmit={handleSubmit}>
          <label htmlFor="firstName">
            <span className="blackOpaque">
              <b>First Name: *</b>
            </span>
          </label>
          <input
        ...
        <p className="center">
          <span className="blackOpaque whiteLink">
            - Or{" "}
