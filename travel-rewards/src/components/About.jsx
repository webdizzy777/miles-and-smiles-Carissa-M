function About(){
    return(
        <>
            <main>
                <div className="card">
                    <h2>Welcome to Miles & Smiles Travel Rewards Tracker!</h2>
                    <p className="left"><i>(By the way, this site was built as a personal project - thanks for stopping by!)</i></p>
                    <p className="left">As long as time can tell, we have been committed to helping you maximize your travel rewards. As a family-owned business that loves to travel, we are dedicated to helping you find ways to create extraordinary experiences filled with joy, comfort, and adventure.</p>
